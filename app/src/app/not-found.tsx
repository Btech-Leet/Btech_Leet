...
export default function NotFoundPage() {
  return (
    <main className="min-h-screen pt-32 pb-20 flex flex-col items-center justify-center px-6 text-center overflow-hidden relative">
      ...
      <div className="relative z-10 space-y-6 max-w-2xl">
        ...
        <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Looks like you&apos;re lost in space!</h2>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6">
          ...
          <a 
            ...
            className="w-full sm:w-auto px-8 py-3.5 bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-700 text-gray-700 dark:text-gray-300 font-bold rounded-xl flex items-center justify-center gap-2 transition-all"
          >
