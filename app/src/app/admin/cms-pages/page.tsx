    ...
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1">Create and manage custom content pages</p>
        </div>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 shadow-sm space-y-5">
          ...
          <form onSubmit={handleSave} className="space-y-4">
            ...
            <div className="flex items-center gap-4 p-4 bg-gray-950 border border-gray-800 rounded-xl">
              <div className="w-24 h-16 rounded-lg bg-gray-900 border border-gray-800 overflow-hidden flex items-center justify-center flex-shrink-0">
                {imageUploading ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-bold text-gray-400 uppercase">SEO Title</label>
          ...
          pages.map((page) => (
            <div key={page.id} className="bg-gray-900 border border-gray-800 rounded-xl p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-sm">
              <div className="flex items-center gap-4 min-w-0 flex-1">
                {page.featuredImage && (
                  <div className="w-16 h-11 rounded-lg bg-gray-950 border border-gray-800 overflow-hidden flex-shrink-0">
