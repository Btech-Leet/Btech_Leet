            ...
            >
              ...
              <div className="bg-gray-50 dark:bg-gray-800/50 px-5 py-3 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold text-white bg-violet-600 hover:bg-violet-700 disabled:opacity-50 transition-colors"
                >
                  {mergingGroup === gIdx ? (
                    ...
                    <div
                      ...
                      className={`px-5 py-3 flex items-center gap-4 transition-colors cursor-pointer ${
                        isPrimary
                          ...
                          : "hover:bg-gray-50/50 dark:hover:bg-gray-800/20 border-l-4 border-transparent"
                      }`}
                      onClick={() =>
