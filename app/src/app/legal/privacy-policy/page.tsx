        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <FadeIn delay={0.1} className="space-y-8 text-base md:text-lg leading-relaxed">
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-white border-b border-gray-800 pb-2">1. Introduction</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-white border-b border-gray-800 pb-2">2. Information We Collect</h2>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-400">
                <li><strong className="text-gray-200">Personal Data:</strong> Name, email address, phone number, college details, and academic targets.</li>
                <li><strong className="text-gray-200">Payment Data:</strong> We may collect data necessary to process your payment if you make purchases, such as your payment instrument number (such as a credit card number), and the security code associated with your payment instrument. All payment data is stored by Razorpay.</li>
              </ul>
            </section>

            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-white border-b border-gray-800 pb-2">3. How We Use Your Information</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-white border-b border-gray-800 pb-2">4. Data Security</h2>
              <p>
